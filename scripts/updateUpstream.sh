...
echo "  - $(bashcolor 1 32)2$(bashcolorend) : Sekiei"
echo "----------------------------------------"
# SCRIPT HEADER end
...
# After the patching, it will copying sources that do no exist in the sekiei workspace but referenced in sekiei patches into our workspace, depending on the content of our patches, this will be addressed by calling importSources.sh.
...
echo "  $(bashcolor 1 32)($subtasks/$subtasks) Succeed$(bashcolorend) - Submodules have been updated, regenerated and imported, run 'sekiei patch' to test/fix patches, and by 'sekiei rbp' to rebuild patches that fixed with the updated upstream."
echo "  "
